...
class ProfilDesaController extends Controller
{
    ...
    public function visiMisi() { return view('frontend.profil-desa.visi-misi'); }
    ...
    public function potensiDesa() { return view('frontend.profil-desa.potensi-desa'); }
    
    public function petaDesa() { return view('frontend.profil-desa.peta-desa'); }
}