    ...
    <div class="container mx-auto px-4 lg:px-8">
        ...
        <nav class="mb-8" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-2 text-sm">
                ...
                <li class="text-primary-400">/</li>
                <li class="text-primary-800 font-medium">{{ ucfirst($kategori) }}</li>
            </ol>
        </nav>
    ...
    <div class="container mx-auto px-4 lg:px-8">
        ...
        <div class="card-bg p-6 rounded-2xl mb-12">
            ...
            @if($search || $tahun)
                <div class="mt-4 flex items-center justify-between">
                    ...
                    <a href="{{ route('berita.kategori', $kategori) }}" class="text-primary-600 hover:text-primary-700 text-sm font-medium">
                        🔄 Reset Filter
                    </a>
                </div>
            @endif
            ...
            <div class="text-center py-16">
                <div class="card-bg rounded-2xl p-12 max-w-lg mx-auto">
                    ...
                    <p class="text-body mb-6">
                        @if($search || $tahun)
                            Tidak ditemukan berita yang sesuai dengan filter yang Anda pilih dalam kategori {{ $kategori }}.
                        @else
                            Saat ini belum ada berita yang dipublikasikan dalam kategori {{ $kategori }}.
                        @endif
                    </p>
                    @if($search || $tahun)
                        <a href="{{ route('berita.kategori', $kategori) }}" class="btn-primary inline-flex items-center space-x-2 px-6 py-3 rounded-xl">
                            <span>🔄 Lihat Semua Berita {{ ucfirst($kategori) }}</span>
                        </a>
                    @else
        ...
        <div class="mt-12 text-center">
            <a href="{{ route('berita.index') }}" 
               class="btn-secondary inline-flex items-center space-x-2 px-8 py-4 rounded-xl font-medium">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
