<section class="py-20 bg-gray-50" id="sotk">
    <div class="container mx-auto px-6">
            ...
            @forelse($sotk as $pamong)
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 group">
                    <div class="relative h-80 overflow-hidden bg-gray-200">
                        {{-- LOGIKA GAMBAR: Cek foto_url (database) terlebih dahulu --}}
                        @php
                            $foto = $pamong->foto_url ?? $pamong->foto ?? $pamong->image;
                        @endphp
                    ...
                    <div class="p-6 text-center">
                        ...
                        {{-- Menggunakan 'jabatan' sesuai database --}}
        ...
        <div class="text-center mt-10">
            {{-- Route ini mengarah ke StrukturOrganisasiController@index yang sudah diperbaiki --}}
