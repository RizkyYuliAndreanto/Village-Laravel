...
<div class="text-center mb-12 px-4">
    <div class="bg-white rounded-3xl shadow-2xl p-10 md:p-16 text-black relative overflow-hidden border border-gray-200">
        <div class="flex flex-col items-center justify-center">
            ...
            <div class="md:hidden w-full max-w-5xl mb-8">
                <div class="flex overflow-x-auto gap-6 pb-4" style="-webkit-overflow-scrolling: touch;">
                    <div class="flex-shrink-0 w-72 flex flex-col items-center p-6 bg-white rounded-xl shadow-lg border border-gray-200 transition-all duration-300 ease-in-out hover:shadow-xl">
            ...
            {{-- Desktop: Grid layout feature cards --}}
            <div class="hidden md:grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-5xl">
